...
export async function generateWebIcons(config, outputDir = DEFAULT_OUTPUT_DIR) {
    ...
    await Promise.all([
        ...
        writeOutput(outputDir, 'logo-standard.svg', standardSvg),
        ...
        renderPng(standardBuffer, 1200).then((png) => writeOutput(outputDir, 'logo-standard.png', png)),
        renderPng(onWhiteBuffer, 1200).then((png) => writeOutput(outputDir, 'logo-on-white.png', png)),
